...
namespace Hypernode\Magento2\Command\Hypernode\Crack;
...
abstract class AbstractCrackCommand extends AbstractMagentoCommand
{
    ...
    public function inject(User $userModel, EncryptorInterface $encryptor, StoreManagerInterface $storeManager, Filesystem $filesystem)
    {
